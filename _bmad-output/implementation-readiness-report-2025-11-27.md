...
- Workflow status file found at \_bmad-output/bmm-workflow-status.yaml; standalone_mode = false.
- Track: method (greenfield). Next expected workflow per path: implementation-readiness (current).
- Completed artifacts: PRD (\_bmad-output/prd.md), Architecture (\_bmad-output/bmm-architecture-2025-11-27.md), Epics (\_bmad-output/epics.md), Test Design (\_bmad-output/bmm-test-design-system-2025-11-27.md). UX design: not provided.
...
- Architecture: \_bmad-output/bmm-architecture-2025-11-27.md
- Epics & Stories: \_bmad-output/epics.md
- Test Design (System-Level): \_bmad-output/bmm-test-design-system-2025-11-27.md
...
- Status updated: implementation-readiness → \_bmad-output/implementation-readiness-report-2025-11-27.md
